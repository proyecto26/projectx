                ...
                <li key={link.href} className="relative">
                  <Link
                    ...
                    className={classnames(
                      "before:-left-1 before:-translate-y-1/2 block w-full pl-3.5 before:pointer-events-none before:absolute before:top-1/2 before:h-1.5 before:w-1.5 before:rounded-full",
