...
- [SSR-First Principle](#ssr-first-principle)
- [Project-Specific Loader Pattern](#project-specific-loader-pattern)
- [TanStack Query SSR Integration](#tanstack-query-ssr-integration)
...
- [Protected Route Loader](#protected-route-loader)

---

## SSR-First Principle

**CRITICAL**: Always use loaders for initial data fetching. This ensures:
...
export default function Dashboard({ loaderData }: Route.ComponentProps) {
  const { data: stats, isLoading } = useQuery({
    ...
    // CRITICAL: Only fetch if loader timed out
